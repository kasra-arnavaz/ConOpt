...
from rendering.rendering import InteriorContactRendering
...
def main(args):
    ...
    contact_images = SceneImages(
        InteriorContactRendering(robot_zbuf=robot_zbuf, other_zbuf=other_zbuf),
        path=PATH,
        prefix="contact",
    )
