...
from cable.cable_factory import MultiCableFactory
from cable.holes_factory import MultiHolesFactory
...
class TestSimulationWithCheckpoint(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        holes = MultiHolesFactory(holes_position).create()
        ...
        cables = MultiCableFactory(holes=holes, pull_ratio=cls.pull_ratio, stiffness=100, damping=0.01).create()
